...
namespace Testing
{
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		void InitializeMeters(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			global::System.Collections.Generic.Dictionary<string, object?> logAndCountMethodTags = new global::System.Collections.Generic.Dictionary<string, object?>();

			PopulateLogAndCountMethodTags(logAndCountMethodTags);

			_logAndCountMethodInstrument = _meter.CreateCounter<int>(name: "multi.log_and_count_method", unit: null, description: null, tags: logAndCountMethodTags);
		}
