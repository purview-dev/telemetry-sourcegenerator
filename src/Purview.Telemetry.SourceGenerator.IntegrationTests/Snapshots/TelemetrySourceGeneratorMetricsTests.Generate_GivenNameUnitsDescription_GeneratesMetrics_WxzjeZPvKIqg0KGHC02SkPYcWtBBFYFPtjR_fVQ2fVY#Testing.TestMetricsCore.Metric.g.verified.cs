...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		public void Metric(global::System.Func<int> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableCounter<int>("testing-meter.an-observablecounter-name-param", f, unit: "pie-param", description: "pie sales per-capita-param."
				, tags: metricTagList
			);
		}
	}
