...
namespace Testing
{
	...
	sealed partial class TestActivitiesCore : global::Testing.ITestActivities
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public global::System.Diagnostics.Activity? ActivityWithNullableReturnActivity(string stringParam, int intParam, bool boolParam)
		{
			if (!_activitySource.HasListeners())
			{
				return null;
			...
			global::System.Diagnostics.Activity? activityActivityWithNullableReturnActivity = _activitySource.StartActivity("ActivityWithNullableReturnActivity", global::System.Diagnostics.ActivityKind.Internal, parentId: default, tags: default, links: default, startTime: default);

			if (activityActivityWithNullableReturnActivity != null)
			{
				activityActivityWithNullableReturnActivity.SetTag("int_param", intParam);
				activityActivityWithNullableReturnActivity.SetTag("bool_param", boolParam);
				activityActivityWithNullableReturnActivity.SetBaggage("string_param", stringParam);
			}
