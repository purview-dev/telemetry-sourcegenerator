...
namespace Testing
{
	...
	{
		static readonly string s_originalFormat = "intValue: {intValue} nullableStringValue: {nullableStringValue} uintValue: {uintValue}";
		...
		{
#if NET
			return string.Create(global::System.Globalization.CultureInfo.InvariantCulture, $"intValue: {_IntValue} nullableStringValue: {_NullableStringValue} uintValue: {_UintValue}");
#else
			return global::System.FormattableString.Invariant($"intValue: {_IntValue} nullableStringValue: {_NullableStringValue} uintValue: {_UintValue}");
#endif
		}
