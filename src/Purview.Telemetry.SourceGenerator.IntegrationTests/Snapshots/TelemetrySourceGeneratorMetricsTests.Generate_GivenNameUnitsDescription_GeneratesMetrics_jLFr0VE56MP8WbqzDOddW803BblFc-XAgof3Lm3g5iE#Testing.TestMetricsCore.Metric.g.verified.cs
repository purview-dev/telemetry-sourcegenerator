...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		public void Metric(global::System.Func<global::System.Collections.Generic.IEnumerable<global::System.Diagnostics.Metrics.Measurement<int>>> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableUpDownCounter<int>("testing-meter.an-observableupdowncounter-name-param", f, unit: "beer-param", description: "beer sales per-capita-param."
				, tags: metricTagList
			);
		}
	}
