...
namespace Testing
{
	...
	sealed partial class TestTelemetryCore : global::Testing.ITestTelemetry
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public void EventMethod(global::System.Diagnostics.Activity? activity, string stringParam, int intParam, bool boolParam, global::System.Exception anException, bool escape)
		{
			if (!_activitySource.HasListeners())
			{
				return;
			...
			if (activity != null)
			{
				...
				tagsCollectionEventMethod.Add("an_exception", anException.ToString());

				global::System.Diagnostics.ActivityEvent activityEventEventMethod = new global::System.Diagnostics.ActivityEvent(name: "EventMethod", timestamp: default, tags: tagsCollectionEventMethod);
