...
namespace Testing
{
	...
	sealed partial class TestActivitiesCore : global::Testing.ITestActivities
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public void ThisIsAMethod(global::System.Diagnostics.Activity activity, string stringParam, int intParam, bool boolParam)
		{
			if (!_activitySource.HasListeners())
			{
				return;
			...
			if (activity != null)
			{
				...
				global::System.Diagnostics.ActivityEvent activityEventThisIsAMethod = new global::System.Diagnostics.ActivityEvent(name: "ThisIsAMethod", timestamp: default, tags: tagsCollectionThisIsAMethod);
