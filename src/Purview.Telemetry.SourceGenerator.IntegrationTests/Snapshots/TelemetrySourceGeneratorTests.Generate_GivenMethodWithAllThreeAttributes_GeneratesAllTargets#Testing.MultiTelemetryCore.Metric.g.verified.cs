...
namespace Testing
{
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		void InitializeMeters(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_fullTelemetryMethodInstrument = _meter.CreateCounter<int>(name: "testing-meter.full_telemetry_method", unit: null, description: null, tags: fullTelemetryMethodTags);
		}
