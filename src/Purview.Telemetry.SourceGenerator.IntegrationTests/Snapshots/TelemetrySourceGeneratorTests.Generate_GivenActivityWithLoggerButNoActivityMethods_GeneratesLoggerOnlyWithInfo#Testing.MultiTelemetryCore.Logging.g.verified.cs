...
namespace Testing
{
	...
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		static readonly global::System.Action<global::Microsoft.Extensions.Logging.ILogger, string, global::System.Exception?> _logOperationAction = global::Microsoft.Extensions.Logging.LoggerMessage.Define<string>(global::Microsoft.Extensions.Logging.LogLevel.Information, new global::Microsoft.Extensions.Logging.EventId(1933755022, "LogOperation"), "LogOperation: OperationId = {OperationId}");
		...
		public void LogOperation(string operationId)
		{
			...
			_logOperationAction(_logger, operationId, null);
		}
