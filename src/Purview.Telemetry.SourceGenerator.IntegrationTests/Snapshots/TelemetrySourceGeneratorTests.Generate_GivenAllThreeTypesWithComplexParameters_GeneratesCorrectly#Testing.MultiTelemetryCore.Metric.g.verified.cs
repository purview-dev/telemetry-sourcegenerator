...
namespace Testing
{
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		void InitializeMeters(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_recordRequestDurationInstrument = _meter.CreateHistogram<double>(name: "multi.record_request_duration", unit: null, description: null, tags: recordRequestDurationTags);
		}
