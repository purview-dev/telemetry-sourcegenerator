...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		void InitializeMeters(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_autoCounterMetricInstrument = _meter.CreateCounter<int>(name: "this.is.an.assembly.prefix.testing-meter.auto.counter.metric", unit: null, description: null, tags: autoCounterMetricTags);
		}
