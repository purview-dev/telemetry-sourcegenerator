...
namespace Testing
{
	...
	sealed partial class InvalidTelemetryCore : global::Testing.IInvalidTelemetry
	{
		...
		readonly global::System.Diagnostics.Metrics.Counter<int> _invalidAsyncCounterInstrument;
		...
		public InvalidTelemetryCore(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_invalidAsyncCounterInstrument = _meter.CreateCounter<int>(name: "invalid.invalid_async_counter", unit: null, description: null, tags: invalidAsyncCounterTags);
		}
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		partial void PopulateInvalidAsyncCounterTags(global::System.Collections.Generic.Dictionary<string, object?> instrumentTags);
