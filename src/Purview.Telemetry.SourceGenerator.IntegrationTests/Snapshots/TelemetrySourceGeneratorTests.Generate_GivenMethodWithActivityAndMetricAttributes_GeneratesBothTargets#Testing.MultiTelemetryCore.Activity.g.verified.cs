...
namespace Testing
{
	...
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		private global::System.Diagnostics.Activity? TraceAndCountMethod_Activity(int counterValue, string operationId)
		{
			...
			global::System.Diagnostics.Activity? activityTraceAndCountMethod = _activitySource.StartActivity("TraceAndCountMethod", global::System.Diagnostics.ActivityKind.Internal, parentId: default, tags: default, links: default, startTime: default);
