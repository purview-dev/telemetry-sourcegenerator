...
namespace Testing
{
	...
	sealed partial class MultiTelemetryCore : global::Testing.IMultiTelemetry
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public global::System.Diagnostics.Activity? Process(string id)
		{
			...
			global::System.Diagnostics.Activity? activityProcess = _activitySource.StartActivity("Process", global::System.Diagnostics.ActivityKind.Internal, parentId: default, tags: default, links: default, startTime: default);

			if (activityProcess != null)
			{
				activityProcess.SetTag("id", id);
			}
