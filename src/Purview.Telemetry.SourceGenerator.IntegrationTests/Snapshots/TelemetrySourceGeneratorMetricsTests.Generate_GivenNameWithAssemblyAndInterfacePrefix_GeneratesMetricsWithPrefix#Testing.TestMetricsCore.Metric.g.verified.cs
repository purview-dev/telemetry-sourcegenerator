...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		public TestMetricsCore(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_autoCounterMetricInstrument = _meter.CreateCounter<int>(name: "this.is.an.assembly.prefix.this.is.a.prefix.auto_counter_metric", unit: null, description: null, tags: autoCounterMetricTags);
		}
