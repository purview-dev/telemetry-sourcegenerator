...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		void InitializeMeters(global::System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_autoCounterMetricInstrument = _meter.CreateCounter<int>(name: "this.is.an.assembly.prefix.this.is.a.prefix.testing-meter.auto-counter", unit: null, description: null, tags: autoCounterMetricTags);
		}
